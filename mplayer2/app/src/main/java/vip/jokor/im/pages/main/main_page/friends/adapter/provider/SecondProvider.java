...
//                .transform(new GlideRoundTransform(context, 8))
    ...
    public void convert(@NotNull BaseViewHolder helper, @Nullable BaseNode data) {
        ...
        if (data instanceof  FriendsBean){
        ...
        if (data instanceof GroupListBean.GroupsBean){
            GroupListBean.GroupsBean entity = (GroupListBean.GroupsBean) data;
            String name = "";
            if (entity.getMsg()==null || entity.getMsg().equals("")){
            ...
            RequestOptions options1 = new RequestOptions()
                    ...
                    .diskCacheStrategy(DiskCacheStrategy.ALL);
            Glide.with(context)
                    .load(entity.getGroup().getIcon())
                    .apply(options1)
                    .into((ImageView) helper.getView(R.id.icon));

            helper.setText(R.id.cpntact_list_item_state,entity.getGroup().getSign());
            helper.setText(R.id.label,"vip");
        }
    }
    ...
    public void onClick(@NotNull BaseViewHolder helper, @NotNull View view, BaseNode data, int position) {
        ...
        if (data instanceof GroupListBean.GroupsBean){
            GroupListBean.GroupsBean entity = (GroupListBean.GroupsBean) data;
            MainPresenter.getInstance().openGroupSession(entity,getContext());
        }
    }
}
