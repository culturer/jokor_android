...
public class DefaultEditorHolder {
    ...
    public static final int DEFAULT_ID_TITLE = R.id.tv_title;

    public static EditorHolder createDefaultHolder() {
        return new EditorHolder(DEFAULT_LAYOUT, DEFAULT_ID_CANCEL, DEFAULT_ID_SEND, DEFAULT_ID_WRITE,DEFAULT_ID_TITLE);
    }
