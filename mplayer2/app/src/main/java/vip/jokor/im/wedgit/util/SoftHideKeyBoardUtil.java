...
public class SoftHideKeyBoardUtil {
	...
	private SoftHideKeyBoardUtil(Activity activity,int statusBarHeight) {
		//1､找到Activity的最外层布局控件，它其实是一个DecorView,它所用的控件就是FrameLayout
		this.statusBarHeight = statusBarHeight;
		FrameLayout content = activity.findViewById(android.R.id.content); //2､获取到setContentView放进去的View
