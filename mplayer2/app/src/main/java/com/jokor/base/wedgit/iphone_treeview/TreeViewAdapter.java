package com.jokor.base.wedgit.iphone_treeview;
...
import com.jokor.base.model.bean.CategorysBean;
...
public class TreeViewAdapter extends BaseExpandableListAdapter implements IphoneTreeView.IphoneTreeHeaderAdapter {
	...
	public int getChildType(int groupPosition){
		if (groupPosition<datas.size()) return MSG_FROM_FRIEND;
		if (groupPosition == datas.size()) return MSG_FROM_GROUP;
