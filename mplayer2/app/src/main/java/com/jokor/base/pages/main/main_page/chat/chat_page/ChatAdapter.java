package com.jokor.base.pages.main.main_page.chat.chat_page;
...
import com.jokor.base.util.audio.AudioPlayer;
...
import com.jokor.base.pages.util.PlayActivity;
...
//			Log.e("testTime", "getView: "+dur );
		...
		if (isMySend){
			...
			if (session.getMsgFrom() == MSG_FROM_GROUP)nick.setVisibility(View.GONE);
