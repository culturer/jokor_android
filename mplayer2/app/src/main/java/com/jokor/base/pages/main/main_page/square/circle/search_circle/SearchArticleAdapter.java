package com.jokor.base.pages.main.main_page.square.circle.search_circle;
...
public class SearchArticleAdapter extends BaseAdapter {
    ...
    public SearchArticleAdapter(Context context, List<FriendsArticlesBean.ArticlesBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View contentView = LayoutInflater.from(context).inflate(R.layout.recommends_list_item,null);
